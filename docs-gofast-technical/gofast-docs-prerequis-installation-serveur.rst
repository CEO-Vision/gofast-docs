...
.. CAUTION:: 
   Le port 10000/udp en sortie du PC doit être ouvert (ou le 4443/tcp avec une perte de qualité). Ceci peut poser des problèmes sur certains réseaux WAN par exemple des sites distants connectés au siège où se trouve le serveur GoFAST. A noter qu'il est rare que ce problème se retrouve sur les réseaux 4G.
