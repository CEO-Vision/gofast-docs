...
Cette ressource permet de consulter les annuaires.

Action : userlist
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Cette action permet de consulter l'annuaire des utilisateurs.

GET
__________

Cette méthode permet de récupérer l'annuaire des utilisateurs.
...
+-------------------+----------------------------------------------+
|page               |Numéro de pages dont renvoyer les résultats   |
+-------------------+----------------------------------------------+
...
|   Clé                 |   Valeur                                                             |
+=======================+======================================================================+
|users                  |Tableau des résultats                                                 |
+-----------------------+----------------------------------------------------------------------+

Les résultats unitaires sont formatés comme suit :
...
+-----------------------+----------------------------------------------------------------------+
|last_login             |Horodatage de la dernière date de connexion                           |
+-----------------------+----------------------------------------------------------------------+
