...
+-------------------+------------------------------------------------------------------+
|    output_shape   |Soit "nid" ou "node" pour changer la forme de la valeur de retour.|
|                   |Introduit en v4.6.0                                               |
+-------------------+------------------------------------------------------------------+
...
si ``output_shape`` vaut "id" ou non spécifié ou avant v4.6.0:

+-----------------------+---------------------+
|   Clé                 |   Valeur            |
+=======================+=====================+
|gid                    | N° de l'espace créé |
+-----------------------+---------------------+

si ``output_shape`` vaut "node":

+-----------------------+----------------------------------------------------+
|   Clé                 |   Valeur                                           |
+=======================+====================================================+
|nid                    | N° de l'espace créé                                |
+-----------------------+----------------------------------------------------+
|type                   | Type du noeud                                      |
+-----------------------+----------------------------------------------------+
|title                  | Titre du noeud                                     |
...
+------------------------+--------------------------------------------------------------------------------------------+
|    role*               |Rôle de l'utilisateur  ("administrator member","group contributor" ou "read only member")   |
+------------------------+--------------------------------------------------------------------------------------------+
...
|      gid*              |N° de noeud de l'espace                                                                              |
+------------------------+-----------------------------------------------------------------------------------------------------+
|      new_role*         |Nouveaux rôles des utilisateurs ("administrator member","group contributor" ou "read only member")   |
+------------------------+-----------------------------------------------------------------------------------------------------+
|    uid OU ul_node_id*  |Identifiant de l'utilisateur OU de la liste d'utilisateurs                                           |
+------------------------+-----------------------------------------------------------------------------------------------------+
...
Cette méthode permet restaurer un espace.

*POST: /api/space/restore*
...
|   Clé             |   Valeur                                           |
+===================+====================================================+
|     success       | Booléen indiquant la réussite de l'opération       |
+-------------------+----------------------------------------------------+
...
Cette méthode permet de supprimer une liste d'utilisateurs.

*DELETE: /api/userlist/userlist*
...
|   Clé                 |   Valeur                                                             |
+=======================+======================================================================+
|status                 |OK si la suppression a réussi                                         |
+-----------------------+----------------------------------------------------------------------+
...
Cette méthode permet de retirer un administrateur de la liste d'utilisateurs.

*DELETE: /api/userlist/admins*
...
|nulid              |N° de noeud de la liste d'utilisateurs        |
+-------------------+----------------------------------------------+
|uid                |Identifiant de l'administrateur à retirer     |
+-------------------+----------------------------------------------+
...
Cette méthode permet de retirer un membre de la liste d'utilisateurs.

*DELETE: /api/userlist/members*
...
|nulid              |N° de noeud de la liste d'utilisateurs        |
+-------------------+----------------------------------------------+
|uid                |Identifiant du membre à retirer               |
+-------------------+----------------------------------------------+
