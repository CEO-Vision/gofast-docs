...
* **-** : ajouté devant un mot-clef permet de l'exclure  (ex : Mémoire Technique -Fonctionnalités) pour indiquer au moteur de recherche que parmi les termes saisis, les documents incluant le mot clef \"Fonctionnalités\" doivent être exclus. 
